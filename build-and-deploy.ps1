# Gitea Bugbot Plugin - Build and Deploy Script
# This script builds the Docker image first, then deploys

Write-Host "🚀 Building and Deploying Gitea Bugbot Plugin..." -ForegroundColor Green
...
if ($LASTEXITCODE -eq 0) {
    ...
    Write-Host "🚀 Deploying the bugbot..." -ForegroundColor Yellow
    ...
    if ($LASTEXITCODE -eq 0) {
        ...
        Write-Host "1. Check the logs: docker-compose -f docker-compose.minimal.yml logs -f gitea-bugbot" -ForegroundColor White
