...
| Key | Legacy alias |
|-----|----------------|
| `REPOSITORY_DETECTIVE_AUTH_MODE` | `BUGBOT_AUTH_MODE` |
| `REPOSITORY_DETECTIVE_SESSION_SECRET` | `BUGBOT_SESSION_SECRET` |
| `REPOSITORY_DETECTIVE_SESSION_TTL_HOURS` | `BUGBOT_SESSION_TTL_HOURS` |
| `REPOSITORY_DETECTIVE_CSRF_ENABLED` | `BUGBOT_CSRF_ENABLED` |
